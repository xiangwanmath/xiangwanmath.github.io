...
**Students users :**
If you are a student, beside an account on the server, you will also need a VPN access (LSA) to connect to the servers (including `mongo1`, `mongo2`, `rock`, `valkyrie`, etc.) A faculty can request both the account setup and the VPN access for you.
